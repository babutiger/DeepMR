...
def test_robustness_number_deeppoly(d):
    ...
    if not os.path.isdir('../../result/original_result'):
        os.makedirs('../../result/original_result')
    file = open(f"../../result/original_result/acas_xu_p6_net_1_1_deeppoly_number_result_delta_{d}_{style_time}.txt", mode="w+", encoding="utf-8")
...
if __name__ == "__main__":
    test_robustness_number_deeppoly(120)
