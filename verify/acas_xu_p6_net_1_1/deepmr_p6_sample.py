import sys as _sys
_DELTA=float(_sys.argv[1]) if len(_sys.argv)>1 else 120.0
import os
...
def test_robustness_number_mrlp(d):
    ...
    if not os.path.isdir('../../result/original_result'):
        os.makedirs('../../result/original_result')
    file = open(f"../../result/original_result/acas_xu_p6_net_1_1_deepmr_3_number_result_delta_{d}_{style_time}.txt", mode="w+", encoding="utf-8")
...
if __name__ == "__main__":
    ...
    test_robustness_number_mrlp(_DELTA)
