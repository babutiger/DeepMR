...
def test_robustness_number_srgrlp(d):
    ...
    if not os.path.isdir('../../result/original_result'):
        os.makedirs('../../result/original_result')
    file = open(f"../../result/original_result/acas_xu_p9_net_3_3_deepsrgr_number_result_delta_{d}_{style_time}.txt", mode="w+", encoding="utf-8")
...
if __name__ == "__main__":
    ...
    test_robustness_number_srgrlp(45)
