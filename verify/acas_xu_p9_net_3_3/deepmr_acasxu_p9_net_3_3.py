...
def test_robustness_number_mrlp(d):
    ...
    net = network()
    net.load_nnet("../../models/nnet/ACASXU_run2a_3_3_batch_2000.nnet")
    property_list = [f"../../acas_properties/acas_xu_p9_net_3_3/local_robustness_{i}.txt" for i in range(1, amount+1)]

    if not os.path.isdir('../../result/original_result'):
        os.makedirs('../../result/original_result')
    file = open(f"../../result/original_result/acas_xu_p9_net_3_3_deepmr_number_result_delta_{d}_{style_time}.txt", mode="w+", encoding="utf-8")
...
if __name__ == "__main__":
    ...
    test_robustness_number_mrlp(45)
