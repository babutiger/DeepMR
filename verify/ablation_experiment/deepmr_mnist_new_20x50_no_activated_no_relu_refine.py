# 消融实验，证明减去 unctivaed relu 没有用，会破坏原来的精度
...
def test_robustness_number_mrlp(d):
    ...
    if not os.path.isdir('../../result/original_result'):
        os.makedirs('../../result/original_result')
    file = open("../../result/original_result/mnist_new_20x50_deepmr_number_result_delta_" + str(d) + "_" + str(style_time) + ".txt", mode="w+", encoding="utf-8")
