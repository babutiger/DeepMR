...
from models.cifar_new_15x200.cifar_net_15x200_model import *
...
def cifar_robustness_radius():
    ...
    style_time = time.strftime("%Y-%m-%d %H:%M:%S", time.localtime(time.time()))
    file = open("../../result/original_result/cifar_new_15x200_alpha_crown_radius_result_" + str(style_time) + ".txt", mode="w+", encoding="utf-8")
