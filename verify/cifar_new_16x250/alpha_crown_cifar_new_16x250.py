...
from models.cifar_new_16x250.cifar_net_16x250_model import *
...
def cifar_robustness_radius():
    ...
    style_time = time.strftime("%Y-%m-%d %H:%M:%S", time.localtime(time.time()))
    file = open("../../result/original_result/cifar_new_16x250_alpha_crown_radius_result_" + str(style_time) + ".txt", mode="w+", encoding="utf-8")
