...
class network(object):
    ...
    def find_robustness_number_mpbp(self, PROPERTY, t, TRIM=False):
        ...
        # Be sure to add this clear() statement, otherwise inconsistencies may occur.
        self.clear()
        self.mpbp_algorithm()
        flag = True
        for neuron_i in self.layers[-1].neurons:
...
def test_robustness_number_mpbp(d):
    ...
    if not os.path.isdir('../../result/original_result'):
        os.makedirs('../../result/original_result')
    file = open(f"../../result/original_result/acas_xu_p5_net_1_1_mpbp_number_result_delta_{d}_{style_time}.txt",
