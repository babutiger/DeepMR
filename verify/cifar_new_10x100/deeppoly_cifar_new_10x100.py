...
def test_robustness_number_poly(d):
    ...
    if not os.path.isdir('../../result/original_result'):
        os.makedirs('../../result/original_result')
    file = open("../../result/original_result/cifar_new_10x100_deeppoly_number_result_delta_"+ str(d) +"_"+ str(style_time) +".txt", mode="w+", encoding="utf-8")
...
if __name__ == "__main__":
    test_robustness_number_poly(0.0027)
