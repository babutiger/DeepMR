...
def cifar_robustness_radius_mpbp():
    ...
    style_time = time.strftime("%Y-%m-%d %H:%M:%S", time.localtime(time.time()))
    file = open("../../result/original_result/cifar_new_10x100_mpbp_radius_result_" + str(style_time) + ".txt", mode="w+",
                encoding="utf-8")
...
def cifar_robustness_radius_lp():
    ...
    if not os.path.isdir('../../result/original_result'):
        os.makedirs('../../result/original_result')
    style_time = time.strftime("%Y-%m-%d %H:%M:%S", time.localtime(time.time()))
    file = open("../../result/original_result/cifar_new_10x100_deepmr_radius_result_" + str(style_time) + ".txt", mode="w+",
                encoding="utf-8")
...
def test_robustness_number_mrlp(d):
    ...
    if not os.path.isdir('../../result/original_result'):
        os.makedirs('../../result/original_result')
    file = open("../../result/original_result/cifar_new_10x100_deepmr_number_result_delta_" + str(d) + "_" + str(style_time) + ".txt", mode="w+", encoding="utf-8")
...
if __name__ == "__main__":
    ...
    test_robustness_number_mrlp(0.0027)
