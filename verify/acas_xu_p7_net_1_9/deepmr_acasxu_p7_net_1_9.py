...
def test_robustness_number_mrlp(d):
    ...
    net = network()
    net.load_nnet("../../models/nnet/ACASXU_run2a_1_9_batch_2000.nnet")
    property_list = [f"../../acas_properties/acas_xu_p7_net_1_9/local_robustness_{i}.txt" for i in range(1, amount+1)]

    if not os.path.isdir('../../result/original_result'):
        os.makedirs('../../result/original_result')
    file = open(f"../../result/original_result/acas_xu_p7_net_1_9_deepmr_number_result_delta_{d}_{style_time}.txt", mode="w+", encoding="utf-8")
