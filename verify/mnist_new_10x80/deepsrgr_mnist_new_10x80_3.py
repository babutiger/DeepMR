...
class network(object):
    ...
    def find_robustness_number_srgrlp(self, PROPERTY, t, TRIM, WORKERS=12, SOLVER=cp.GUROBI):
...
if __name__ == "__main__":
    ...
    test_robustness_number_srgrlp(0.8)
