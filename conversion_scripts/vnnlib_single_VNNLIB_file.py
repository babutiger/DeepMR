...
def txt_to_vnnlib(input_txt_path, output_dir=None, epsilon=0.1):
    """
    Converts an MNIST-like txt file to vnnlib format with added perturbation.

    Args:
        input_txt_path (str): Path to the input txt file.
        output_dir (str, optional): Directory to save the output vnnlib file. If None, the output will be saved in the same directory as the input file.
...
# Example usage
txt_to_vnnlib("../mnist_properties/mnist_properties_10x80/mnist_property_0.txt", output_dir="../mnist_vnnlib", epsilon=0.1)
